...
public class FindArray2 {
    ...
    public static boolean Find(int [][] array,int target) {
       if(array==null){
           ...
           for(int i=0;i<array.length;i++){
               int find=findArray1(array[i],target);
               if(find>=0)
                   return true;
           }
       }
    ...
    private static int findArray1 (int[] array,int target){
        if(array.length>0){
